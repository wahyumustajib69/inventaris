...
function Header()
{
    ...
    $this->Cell(30);
    // Judul
    $this->Cell(30,5,'LAPORAN DATA KATEGORI',0,1,'L');
    $this->Cell(30);
...
$pdf->Cell(85,6,'NAMA KATEGORI',1,0,'C',0);
$pdf->Cell(85,6,'KETERANGAN',1,1,'C',0);
...
while($row = mysqli_fetch_array($sql)){
	$pdf->SetFont('Arial','',9);
	$pdf->Cell(10,6,$no,1,0,'C',0);
    $pdf->Cell(85,6,$row['nama'],1,0,'L',0);
    //$pdf->Cell(45,6,$row['status'],1,0,'L',0);
