...
function Header()
{
    ...
    $this->Cell(30);
    // Judul
    $this->Cell(30,5,'LAPORAN DATA RUANGAN',0,1,'L');
    $this->Cell(30);
...
$pdf->Cell(65,6,'NAMA RUANGAN',1,0,'C',0);
$pdf->Cell(45,6,'STATUS',1,0,'C',0);
$pdf->Cell(70,6,'KETERANGAN',1,1,'C',0);
